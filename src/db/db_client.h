...
class CDbClient{
    ...
    class DbResult{
        ...
        int getInt(daoType::retType long lRow, long lColumn);
        std::string getString(daoType::retType long lRow, long lColumn);
        std::date getData(daoType::retType long lRow, long lColumn);
    };
